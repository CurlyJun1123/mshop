    ...
    <block v-if="shopApplyData">
      <view class="audit-status">
        ...
        <view class="color-sub">
          {{ auditInfo['procedure_' + procedure].text }}
          <text class="color-base-text" @click="getApplyMessage">{{ auditInfo['procedure_' + procedure].error }}</text>
        </view>
      </view>
      ...
      <button class="audit-btn color-base-bg" type="default" v-if="auditInfo['procedure_' + procedure].btn" @click="linkSkip">
        {{ auditInfo['procedure_' + procedure].btn }}
      </button>
    </block>
