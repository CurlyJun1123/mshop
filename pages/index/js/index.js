export default {
	data() {
		return {
			...
			picker: [{
					date_value: 7,
					date_text: this.$t('index.seven_days')
				},
				{
					date_value: 15,
					date_text: this.$t('index.fifteen_days')
				},
				{
					date_value: 30,
					date_text: this.$t('index.thirty_days')
				}
			]
		};
	},
	...
	onShareAppMessage(res) {
		var title = this.$t('index.share_title');
